    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                ...
                <p>💾 Save this report | 🃏 Export to Anki | 📥 Download PDF</p>
            </div>
        </div>
        ...
        if error_patterns:
            ...
            for error in error_patterns[:5]:  # 显示前5个错误
                ...
                <div class="error-pattern">
                    <div class="error-type">{error.get('error_type', 'Unknown Error')}</div>
        ...
        if complex_sentences:
            ...
            for sent in complex_sentences[:3]:
                ...
                <div class="complex-sentence">
                    ...
                    {f'<div class="breakdown"><strong>Tip:</strong> {sent.get("suggestion", "")}</div>' if sent.get('suggestion') else ''}
                </div>
                """
            complex_html += '</div>'
